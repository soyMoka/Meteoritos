...
func conectar_seniales()->void:
	...
	Eventos.connect("cambio_numero_metroritos", self, '_on_actualizar_numero_meteoritos')
...
func _on_actualizar_numero_meteoritos(numero:int)->void:
...
# warning-igore:narrowing_conversion
	var minutos:int = floor(tiempo_restante * 0.016666666666666667)
